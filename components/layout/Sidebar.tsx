...
import { User, Camera, Globe, Film, Layers, CreditCard, Folder, Plus, ChevronDown, Clapperboard, Edit2, Check, Languages, Settings, Sparkles, Cloud, RefreshCw } from 'lucide-react';
...
const NavItem = memo(({ mode, current, icon: Icon, label, setMode }: NavItemProps) => (
    ...
    >
        ...
        {current === mode && (
            <div className="absolute right-3 w-1.5 h-1.5 rounded-full bg-[var(--neon-primary)] shadow-[0_0_10px_var(--neon-primary)] animate-pulse"></div>
        )}
    </button>
));
...
export const Sidebar: React.FC = memo(() => {
    ...
    return (
        <div className="w-64 h-full glass-panel border-r border-white/5 flex flex-col shrink-0 z-20 hidden lg:flex justify-between transition-colors duration-500">
            <div>
                <div className="h-20 flex items-center px-6 border-b border-white/5 gap-3 group cursor-pointer" onClick={() => setMode(AppMode.DIRECTOR)}>
                    {/* GEMINI STUDIO BRANDING - Premium Animated */}
                    ...
                    <div className="flex flex-col leading-none select-none">
                        ...
                        <div className="flex items-center gap-1">
                            ...
                            <div className="h-[2px] w-full bg-[var(--neon-primary)] rounded-full opacity-50 group-hover:opacity-100 group-hover:shadow-[0_0_8px_var(--neon-primary)] transition-all"></div>
                        </div>
                    </div>
                </div>
                ...
                <div className="p-4 relative space-y-2">
                    ...
                    <button 
                        ...
                        className="w-full flex items-center gap-2 bg-slate-800/30 border border-white/5 rounded-lg p-2 text-white/50 hover:text-white hover:bg-slate-800 transition-colors text-xs group"
            ...
            <div className="space-y-4">
                ...
                <div className="mx-6 py-2 border-t border-white/5 flex items-center justify-between text-[9px] text-white/30 uppercase tracking-widest">
                    <span className="flex items-center gap-2">
                        <Cloud size={10} className="text-[var(--neon-secondary)]" /> Sync Active
                    </span>
                ...
                {/* SONI NEW MEDIA LOGO - SVG Implementation */}
                    ...
                    <div className="flex flex-col leading-none select-none">
                        <div className="flex items-center gap-2">
                            ...
                            <svg width="28" height="18" viewBox="0 0 28 18" fill="none" xmlns="http://www.w3.org/2000/svg" className="shrink-0">
                                ...
                                <path fillRule="evenodd" clipRule="evenodd" d="M19 9C19 13.9706 14.9706 18 10 18C5.02944 18 1 13.9706 1 9C1 4.02944 5.02944 0 10 0C14.9706 0 19 4.02944 19 9ZM14 9C14 11.7614 11.7614 14 9 14C6.23858 14 4 11.7614 4 9C4 6.23858 6.23858 4 9 4C11.7614 4 14 6.23858 14 9Z" fill="white" style={{ mixBlendMode: 'exclusion' }}/>
                                <circle cx="19" cy="9" r="9" fill="white" style={{ mixBlendMode: 'exclusion' }}/>
                            </svg>
